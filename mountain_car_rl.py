...
class DQN:
    def __init__(self, state_size, action_size):
        ...
        self.loss = tf.reduce_mean(tf.squared_difference(self.action_values, self.target))
    ...
    def _build_model(self):
        ...
        second_layer = snt.Linear(self.action_size)
    ...
    def replay(self, batch_size):
        ...
        for state, action, reward, next_state, done in minibatch:
            ...
            print(values['action_value'], target_f)
